...
class Score:
    def __init__(self,n_mines):
        ...
        self.max_num_of_moves_counted_as_penalty = n_mines * _MAX_MOVE_PENALTY_MULTIPLIER / _SCORE_PER_MOVE
        self.max_num_of_shots_counted_as_penalty = n_mines * _MAX_SHOT_PENALTY_MULTIPLIER / _SCORE_PER_SHOT
